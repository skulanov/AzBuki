...
const churchSlavonicAlphabet = [
    ...
    { uppercase: String.fromCodePoint(0x0405), String.fromCodePoint(0x0455), name: "ѕѣло́" },
    { uppercase: String.fromCodePoint(0x0417), String.fromCodePoint(0x0437), name: "земля́" },
    ...
    { uppercase: String.fromCodePoint(0x041A), String.fromCodePoint(0x043A), name: "ка́ко" },
    { uppercase: String.fromCodePoint(0x041B), String.fromCodePoint(0x043B), name: "лю́диє" },
    { uppercase: String.fromCodePoint(0x041C), String.fromCodePoint(0x043C), name: "мыслѣ́тє" },
    { uppercase: String.fromCodePoint(0x041D), String.fromCodePoint(0x043D), name: "нашь" },
    ...
    { uppercase: String.fromCodePoint(0x047E), String.fromCodePoint(0x0047F), name: "о́тъ" },
    ...
    { uppercase: String.fromCodePoint(0x0462), String.fromCodePoint(0x0463), name: "ять" },
    ...
    { uppercase: String.fromCodePoint(0x0472), String.fromCodePoint(0x0473), name: "ѳи́та" },
    { uppercase: String.fromCodePoint(0x0474), String.fromCodePoint(0x0475), name: "ижи́ца" }
];
